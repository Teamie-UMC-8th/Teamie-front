...
export default function ProjectMasterPortfolioPage() {
  ...
  return (
    <div className="relative w-full min-h-screen pb-[1000px]">
      ...
      {/* 탭 버튼 그룹 */}
      <div className="absolute top-[185px] left-[168px] w-fit h-[42px] bg-[#F8F8F8] border border-[#E7E7E7] rounded-[4px] flex items-center px-[4px] py-[4px] gap-[10px]">
        <button
        ...
        <button
          ...
          className={`px-[12px] py-[4px] rounded-[4px] flex items-center justify-center
                      font-[Pretendard] text-[18px] leading-[26px] whitespace-nowrap transition-all
                      ${
      ...
      {/* 날짜, 분류, 기여도 묶음 */}
      <div className="absolute top-[279px] left-[214px] flex items-center gap-[85px]">
        {/* 진행 기간 */}
        <div className="flex items-center gap-[28px] w-[246px]">

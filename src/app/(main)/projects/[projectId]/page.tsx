...
export default function ProjectHomePage() {
  return (
    <div>
      ...
      {/* 게시판, 업데이트 */}
      <div className="flex mt-[68px] gap-[29px]">
        <div className="flex-col">
          <p className="text-[22px] font-semibold">게시판</p>
          <div className="w-[920px] h-[344px] border-[2px] border-[#BBBBBB] mt-[24px] rounded-[8px] px-[48px] py-[36px] gap-x-[48px] gap-y-[32px]">
            <img src="/icons/Post-it.svg" alt="게시판 포스트잇" className="relative" />
          </div>
        </div>
        <div className="flex-col">
          <p className="text-[22px] font-semibold">업데이트</p>
          <div className="w-[466px] h-[344px] border-[2px] border-[#BBBBBB] mt-[24px] rounded-[8px]"></div>
        </div>
      </div>
      {/* 팀 목표, 규칙 */}
      <div className="flex mt-[80px] gap-[42px]">
        <div>
      ...
      {/* 팀원 프로필 */}
      <div className="mt-[82px] w-[1416px]">
        ...
        >
          <img src="/icons/myprofile.svg" alt="Profile" className="w-[125px] h-[125px] ml-[55px]" />
          ...
          <div className="w-[235px] h-[248px] flex-col mt-[18px]">

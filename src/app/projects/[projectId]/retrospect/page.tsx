...
export default function PersonalRetroPage() {
  ...
  return (
    <div className="absolute top-[120px] left-[313px] laptop:static laptop:p-[20px]">
      {/* 제목 */}
      <h2 className="w-fit mb-[16px] font-[Pretendard] font-bold text-[24px] leading-[29px] tracking-[0.04em] whitespace-nowrap text-[#000000] not-italic">
        개인 회고
      </h2>
      ...
      {/* 버튼 */}
      <div className="w-fit h-[42px] bg-[#F8F8F8] border border-[#E7E7E7] rounded-[4px] flex items-center px-[4px] py-[4px] gap-[10px] mb-[40px] flex-wrap">
        <button

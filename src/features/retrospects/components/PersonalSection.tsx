  ...
  return (
    <div className="w-full flex justify-center">
      <div className="w-full flex flex-col items-center gap-[28px] px-[16px]">
        ...
        {/* 섹션 1 */}
        <div className="w-[1415px] max-lg:w-[862px] h-[588px] max-lg:h-[542px] bg-[#F8F8F8] shadow-[0_0_4px_rgba(0,0,0,0.2)] rounded-[16px] px-[40px] pt-[32px] pb-[52px] mb-[28px] max-lg:px-[20px] max-lg:pt-[24px] max-lg:pb-[28px]">
          <h2 className="font-[Pretendard] text-[#000000] font-bold text-[20px] leading-[28px] mb-[8px] max-lg:text-[18px] max-lg:leading-[26px]">
            1. 나의 역할과 일하는 방식
          </h2>
          <ul className="list-disc list-outside pl-[30px] space-y-[8px] text-[16px] leading-[24px] font-[Pretendard] font-normal text-[#000000] marker:text-[11px] mb-[28px] max-lg:pl-[28px]">
        ...
        <div className="w-[1415px] max-lg:w-[862px] h-[588px] max-lg:h-[542px] bg-[#F8F8F8] shadow-[0_0_4px_rgba(0,0,0,0.2)] rounded-[16px] px-[40px] pt-[32px] pb-[52px] mb-[28px] max-lg:px-[20px] max-lg:pt-[24px] max-lg:pb-[28px]">
          ...
          <ul className="list-disc list-outside pl-[35px] space-y-[8px] text-[16px] leading-[24px] font-[Pretendard] font-normal text-[#000000] marker:text-[11px] mb-[28px] max-lg:pl-[20px] max-lg:text-[15px] max-lg:marker:text-[10px]">

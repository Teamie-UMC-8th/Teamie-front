export default function PersonalSection() {
  return (
    <div className="ml-[40px]">
      {/* 섹션 1 */}
      <div className="w-[1415px] h-[588px] bg-[#F8F8F8] shadow-[0_0_4px_rgba(0,0,0,0.2)] rounded-[12px] px-[40px] pt-[32px] pb-[52px] mb-[28px]">
        <h2 className="font-[Pretendard] text-[#000000] font-bold text-[20px] leading-[28px] mb-[8px]">
          1. 나의 역할과 일하는 방식
        </h2>
        <ul className="list-disc list-outside pl-[35px] space-y-[8px]

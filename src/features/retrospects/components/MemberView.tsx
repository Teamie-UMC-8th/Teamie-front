    ...
    <div>
      ...
      >
        ...
        <div className="w-[562px] h-[310px] bg-[#F8F8F8] rounded-[16px] shadow-[0_0_15px_rgba(0,0,0,0.2)] flex flex-col items-center text-center p-[24px] pt-[53px] text-[#898989]">
          <strong className="w-[562px] h-[26px] text-[18px] font-bold leading-[26px] mb-[33px]">
            팀장만 종료 가능합니다.
          </strong>
          <p className="w-[562px] h-[72px] text-[16px] leading-[24px] mb-[40px]">
        ...
        <div className="w-[562px] h-[310px] bg-white rounded-[16px] shadow-[0_0_15px_rgba(0,0,0,0.2)] flex flex-col items-center text-center p-[24px] pt-[40px]">
          <strong className="w-[342px] h-[52px] text-[18px] font-bold leading-[26px] mb-[20px]">
            팀장은 이탈이 불가능합니다. <br />
            팀장 권한을 타 팀원에게 부여한 후 이탈해주세요.
          </strong>
          <p className="w-[562px] h-[72px] text-[16px] leading-[24px] text-black mb-[40px]">
            프로젝트에서 이탈하면 팀원들과의 실시간 연동이 종료되며, <br />
            업로드한 자료는 팀원들이 자유롭게 사용할 수 있습니다. <br />팀 회고는 진행되지 않으며,
            개인 회고만 진행하게 됩니다.
          </p>
          <button
      ...
      {showFinalModal && (
        <FinalLeaveModal onConfirm={handleFinalLeave} onCancel={() => setShowFinalModal(false)} />
      )}
    </div>
  );
}

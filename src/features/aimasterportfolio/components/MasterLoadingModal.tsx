...
export default function LoadingModal({ isOpen, startFromLast = false }: LoadingModalProps) {
  const steps: LoadingStep[] = useMemo(
    () => [
      ...
      {
        key: 'draft',
        frames: ['/icons/drafting1.svg', '/icons/drafting2.svg'],
        message: '티미가 초안을 작성하고 있어요...',
        durationMs: 10_000,
      },
      {
        key: 'write',
        frames: ['/icons/writing1.svg', '/icons/writing2.svg'],
        message: '티미가 마스터 포트폴리오를 작성하고 있어요...',
        durationMs: 15_000,
      },
      {
        key: 'review',
      ...
      {
        key: 'modify',
        frames: ['/icons/modify1.svg', '/icons/modify2.svg'],
        message: '티미가 마스터 포트폴리오를 수정하고 있어요...',
        durationMs: 20_000,
      },
      {
        key: 'last',
